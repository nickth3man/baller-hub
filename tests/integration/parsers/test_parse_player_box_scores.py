...
class TestNovemberFirst2006(BaseBoxScoresTestCase):
    ...
    def test_length(self):
        assert len(self._parsed_results) == 272
...
class TestDecemberEighteenth2015(BaseBoxScoresTestCase):
    ...
    def test_length(self):
        assert len(self._parsed_results) == 250
...
class TestNovemberThird2003(BaseBoxScoresTestCase):
    ...
    def test_length(self):
        assert len(self._parsed_results) == 145
...
class TestDecemberTwelfth2017(BaseBoxScoresTestCase):
    ...
    def test_length(self):
        assert len(self._parsed_results) == 149
...
class TestJanuaryTwentyNinth2017(BaseBoxScoresTestCase):
    ...
    def test_length(self):
        assert len(self._parsed_results) == 170
    ...
    def test_paul_millsap(self):
        ...
        assert paul_millsap["seconds_played"] == 3607
        assert paul_millsap["made_field_goals"] == 13
        assert paul_millsap["attempted_field_goals"] == 29
        assert paul_millsap["made_three_point_field_goals"] == 3
        assert paul_millsap["attempted_three_point_field_goals"] == 8
        assert paul_millsap["made_free_throws"] == 8
        assert paul_millsap["attempted_free_throws"] == 10
        assert paul_millsap["offensive_rebounds"] == 8
        assert paul_millsap["defensive_rebounds"] == 11
        assert paul_millsap["assists"] == 7
        assert paul_millsap["steals"] == 1
        assert paul_millsap["blocks"] == 0
        assert paul_millsap["turnovers"] == 3
        assert paul_millsap["personal_fouls"] == 4
        assert paul_millsap["game_score"] == 31.3
