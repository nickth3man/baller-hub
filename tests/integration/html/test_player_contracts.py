...
class TestPlayerContractsRow(TestCase):
    def test_final_contract_year_player(self):
        ...
        assert row.player_name == "Pascal Siakam"
        assert row.player_identifier == "siakapa01"
        assert row.team_abbreviation == "IND"
        assert row.first_contract_year_data == ("$37,893,408", "right ")
        assert row.second_contract_year_data == ("", "right iz")
        assert row.third_contract_year_data == ("", "right iz")
        assert row.fourth_contract_year_data == ("", "right iz")
        assert row.fifth_contract_year_data == ("", "right iz")
        assert row.sixth_contract_year_data == ("", "right iz")
    ...
    def test_player_with_no_empty_contract_years_and_no_team_or_player_options(self):
        ...
        assert row is not None
        assert row.player_name == "Jaylen Brown"
        assert row.player_identifier == "brownja02"
        assert row.team_abbreviation == "BOS"
        assert row.first_contract_year_data == ("$31,830,357", "right ")
        assert row.second_contract_year_data == ("$49,700,000", "right ")
        assert row.third_contract_year_data == ("$53,676,000", "right ")
        assert row.fourth_contract_year_data == ("$57,652,000", "right ")
        assert row.fifth_contract_year_data == ("$61,628,000", "right ")
        assert row.sixth_contract_year_data == ("$65,604,000", "right ")
    ...
    def test_player_with_single_year_player_option(self):
        ...
        assert row.player_name == "Gary Trent Jr."
        assert row.player_identifier == "trentga02"
        assert row.team_abbreviation == "TOR"
        assert row.first_contract_year_data == ("$18,560,000", "right salary-pl")
        assert row.second_contract_year_data == ("", "right iz")
        assert row.third_contract_year_data == ("", "right iz")
        assert row.fourth_contract_year_data == ("", "right iz")
        assert row.fifth_contract_year_data == ("", "right iz")
        assert row.sixth_contract_year_data == ("", "right iz")
        assert row.guaranteed == "$18,560,000"
    ...
    def test_player_with_single_year_team_option(self):
        ...
        assert row.player_name == "James Wiseman"
        assert row.player_identifier == "wisemja01"
        assert row.team_abbreviation == "DET"
        assert row.first_contract_year_data == ("$12,119,440", "right salary-tm")
        assert row.second_contract_year_data == ("", "right iz")
        assert row.third_contract_year_data == ("", "right iz")
        assert row.fourth_contract_year_data == ("", "right iz")
        assert row.fifth_contract_year_data == ("", "right iz")
        assert row.sixth_contract_year_data == ("", "right iz")
        assert row.guaranteed == "$12,119,440"
