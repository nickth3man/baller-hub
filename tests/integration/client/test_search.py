...
class TestJa(TestCase):
    def setUp(self):
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/0.html"),
            encoding="utf-8",
        ) as file_input:
            self._html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/1.html"),
            encoding="utf-8",
        ) as file_input:
            self._1_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/2.html"),
            encoding="utf-8",
        ) as file_input:
            self._2_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/3.html"),
            encoding="utf-8",
        ) as file_input:
            self._3_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/4.html"),
            encoding="utf-8",
        ) as file_input:
            self._4_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/5.html"),
            encoding="utf-8",
        ) as file_input:
            self._5_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/6.html"),
            encoding="utf-8",
        ) as file_input:
            self._6_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/7.html"),
            encoding="utf-8",
        ) as file_input:
            self._7_html = file_input.read()
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/ja/8.html"),
            encoding="utf-8",
        ) as file_input:
    ...
    def test_length(self, m):
        ...
        assert len(results["players"]) == 863
        assert {"name": "LeBron James", "identifier": "jamesle01", "leagues": set()} == results["players"][0]
...
class TestAlonzoMourning(TestCase):
    def setUp(self):
        with open(
            os.path.join(
                os.path.dirname(__file__), "../files/search/Alonzo Mourning.html"
            ),
            encoding="utf-8",
        ) as file_input:
            self._html = file_input.read()
...
class TestDominiqueWilkins(TestCase):
    def setUp(self):
        with open(
            os.path.join(
                os.path.dirname(__file__), "../files/search/Dominique Wilkins.html"
            ),
            encoding="utf-8",
        ) as file_input:
            self._html = file_input.read()
    ...
    def test_result(self, m):
        ...
        assert [{"name": "Dominique Wilkins", "identifier": "wilkido01", "leagues": set()}] == results["players"]
...
class TestRickBarry(TestCase):
    def setUp(self):
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/Rick Barry.html"),
            encoding="utf-8",
        ) as file_input:
            self._html = file_input.read()
    ...
    def test_result(self, m):
        ...
        assert [{"name": "Rick Barry", "identifier": "barryri01", "leagues": set()}] == results["players"]
...
class TestJaebaebae(TestCase):
    def setUp(self):
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/jaebaebae.html"),
            encoding="utf-8",
        ) as file_input:
            self._html = file_input.read()
...
class TestKobeBryant(TestCase):
    def setUp(self):
        with open(
            os.path.join(os.path.dirname(__file__), "../files/search/kobe bryant.html"),
            encoding="utf-8",
        ) as file_input:
            self._html = file_input.read()
    ...
    def test_result(self, m):
        ...
        assert [{"name": "Kobe Bryant", "identifier": "bryanko01", "leagues": set()}] == results["players"]
...
class TestKobe(TestCase):
    def setUp(self):
        with open(
            os.path.join(ARCHIVE_SEARCH_DIR, "kobe.html"), encoding="utf-8"
        ) as file_input:
            self._html = file_input.read()
    ...
    def test_result(self, m):
        ...
        assert [{"name": "Kobe Bryant", "identifier": "bryanko01", "leagues": set()}, {"name": "Ruben Patterson", "identifier": "patteru01", "leagues": set()}, {"name": "Dion Waiters", "identifier": "waitedi01", "leagues": set()}, {"name": "Austin Reaves", "identifier": "reaveau01", "leagues": set()}, {"name": "Kobe Bufkin", "identifier": "bufkiko01", "leagues": set()}, {"name": "Kobe Brown", "identifier": "brownko01", "leagues": set()}, {"name": "Oleksandr Kobets", "identifier": "kobetol01", "leagues": set()}] == results["players"]
