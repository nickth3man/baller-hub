...
class TestDraftPage(TestCase):
    ...
    def test_draft_table_query(self):
        ...
        from src.scraper.html.draft import DraftPage  # noqa: PLC0415
    ...
    def test_rows_returns_draft_rows_when_found(self, _mock_xpath):  # noqa: PT019
        """Test that draft rows are returned when found."""
        from src.scraper.html.draft import DraftPage, DraftRow  # noqa: PLC0415
...
class TestDraftRow(TestCase):
    ...
    def test_pick_query(self):
        ...
        from src.scraper.html.draft import DraftRow  # noqa: PLC0415
