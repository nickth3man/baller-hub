...
backward compatibility with existing imports from src.parsers.
"""
...
# Box score parsers
from src.parsers.box_scores import (
...
from src.parsers.play_by_play import (
    PeriodDetailsParser,
...
# Player parsers
from src.parsers.player import (
    PlayerAdvancedSeasonTotalsParser,
    PlayerSeasonTotalsParser,
)

# Schedule parsers
from src.parsers.schedule import (
...
# Search parsers
from src.parsers.search import (
    PlayerDataParser,
...
# Standings parsers
from src.parsers.standings import (
