...
class DraftPage:
    ...
    def year(self) -> str | None:
        """Extract draft year from page header."""
...
class DraftRow:
    ...
    def pick_query(self) -> str:
        """XPath query for overall pick number."""
        return 'td[@data-stat="pick_overall"]'

    @property
    def round_query(self) -> str:
        """XPath query for round pick."""
    ...
    def years_active_query(self) -> str:
        """XPath query for years active in NBA."""
        return 'td[@data-stat="years_played"]'

    @property
    def pick(self) -> str | None:
        """Extract overall pick number."""
