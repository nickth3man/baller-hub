...
class PlayoffsPage:
    ...
    def finals_mvp(self) -> str | None:
        """str | None: Extract Finals MVP name."""
    ...
    def series_links(self) -> list[str]:
        """list[str]: Extract links to individual series pages."""
